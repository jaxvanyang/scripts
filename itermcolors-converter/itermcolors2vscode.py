...
bright_colors_vscode = list(
    map(lambda color: str.replace("ansi" + color, " ", ""), bright_colors)
)
...
def main(file_name):
    with open(file_name, "rb") as fp:
        ...
        print(
            "// usage see https://stackoverflow.com/questions/42307949/color-theme-for-vs-code-integrated-terminal"
        )
